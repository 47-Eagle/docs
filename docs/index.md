...
|----------|---------|----------|
| 🏛️ **EagleOVault** (ERC4626) | [Core vault managing dual-token LP strategy](./contracts/eagle-ovault) | <span class="badge badge--warning">ERC4626</span> |
...
- 🏗️ **[Architecture Deep Dive](./dev/architecture)** - Understanding the system
...
2. **[🏗️ Architecture](./dev/architecture)** - Understand the elegance
